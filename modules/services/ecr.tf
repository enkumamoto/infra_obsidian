...
# resource "aws_ecr_repository" "blackstone-monitor" {
#   name                 = "blackstone/blackstone-monitor"
#   image_tag_mutability = "MUTABLE"
...
# output "blackstone-monitor_url" {
#   value = aws_ecr_repository.blackstone-monitor.repository_url
# }
...
# ## blackstone Monitor
# data "docker_registry_image" "blackstone-monitor" {
#   name = "hello-world"
# }

# resource "docker_image" "blackstone-monitor" {
#   name = data.docker_registry_image.blackstone-monitor.name
# }

# resource "docker_tag" "blackstone-monitor_ecr_tag" {
#   target_image = "${aws_ecr_repository.blackstone-monitor.repository_url}:latest"
#   source_image = data.docker_registry_image.blackstone-monitor.name
# }

# output "image-blackstone-monitor" {
#   value = "${aws_ecr_repository.blackstone-monitor.repository_url}:latest"
# }

# resource "docker_registry_image" "blackstone-monitor_ecr" {
#   name = "${aws_ecr_repository.blackstone-monitor.repository_url}:latest"
# }
