...
#   name            = "obsidian-alb-${var.environment}"
...
#   tags = merge(local.tags, { Name = "obsidian-alb-${var.environment}" })
# }

# resource "aws_lb_target_group" "frontend_alb_target_group" {
#   name        = "obsidian-ui-alb-target-group"
...
#   tags = merge(local.tags, { Name = "obsidian-ui-alb-target-group-${var.environment}" })
# }
...
#   tags = merge(local.tags, { Name = "obsidian-ui-alb-listener-rule-${var.environment}" })
# }

# # # NLB
# # resource "aws_lb" "obsidian-nlb" {
# #   name            = "obsidian-nlb-${var.environment}"
# #   internal        = false # Public facing ALB 
# #   security_groups = [aws_security_group.allow_service_access.id]
# #   subnets         = var.vpc_config_public_subnet_ids
...
# #   tags = merge(local.tags, { Name = "obsidian-nlb-${var.environment}" })
# # }

# # # Target Group para o NLB
# # resource "aws_lb_target_group" "nlb_target_group" {
# #   name        = "obsidian-nlb-target-group"
# #   port        = 8080 # Altere a porta se o seu serviço usar uma porta diferente
# #   protocol    = "HTTP"
# #   vpc_id      = var.vpc_id
# #   target_type = "ip" # Use instance para tarefas ECS

# #   tags = merge(local.tags, { Name = "obsidian-nlb-target_group-${var.environment}" })
# # }

# # # Listener para o NLB
# # resource "aws_lb_listener" "nlb_listener" {
# #   load_balancer_arn = aws_lb.obsidian-nlb.arn
# #   port              = 8080
# #   protocol          = "TCP"
